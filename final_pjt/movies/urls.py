...
urlpatterns = [
    ...
    path('<int:movie_pk>/<int:review_pk>/<int:comment_id>/update/', views.comment_update, name='comment_update'),
    path('<int:movie_pk>/<int:review_pk>/<int:comment_id>/delete/', views.comment_delete, name='comment_delete'),
]